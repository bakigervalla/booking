...
import { useVehicles, searchVehicle, setEUKontroll } from '../../context/VehicleState'
    ...
    return (
        <>
            ...
            <div className="grid lg:grid-cols-2 md:grid-cols-1 gap-x-20 gap-y-2 lg:w-6/12 md:w-full">
                ...
                <SearchBox setShowResults={setShowResults} showResults={showResults} vehicle={vehicle} onEUKontroll={_onEUKontroll} />
            </div >
        </>
    )
}
