...
import LimitedInput from "../layout/LimitedInput";
import LimitedTextarea from "../layout/LimitedTextarea";
import {
  useVehicles,
  findPerson,
  submitOrder,
...
const PersonalInfo = ({ workshop }) => {
  ...
  const { vehicles, person, filtered, serviceAgreement, step, loading } =
    vehicleState;
  ...
  useEffect(() => {
    ...
    fillData({
      ...
      first_name:
        person.fornavn === undefined ? "" : person.fornavn?.split(" ")[0],
                ...
                <div className="rightcontact grid-rows-2 border-l-2 pl-8 border-dotted">
                  <div className="h-20">
                    ...
                    <LimitedInput
                      value={data.request || ""}
                      limit={24}
                      action={handleChange("request")}
                      args={{ type: "text", name: "request" }}
                      labelArgs={{ width: "47%", textAlign: "right" }}
                    />
                  </div>
                  <div>
                    ...
                    <LimitedTextarea
                      ...
                      limit={150}
                      args={{ name: "message" }}
                      action={handleChange("message")}
                      labelArgs={{ width: "73%", textAlign: "right" }}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="grid gap-4">
                <div className="leftcontact grid-rows-6">
                  ...
                  <div className="">
                    <p>Telefonnummer *</p>
                    <div className="flex">
                      <div className="input-label-grey w-1/6 h-[2.1rem]">
                        +47
                      </div>
                      <div className="w-full border-l-transparent">
                        <input
